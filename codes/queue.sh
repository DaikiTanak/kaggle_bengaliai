...
python train.py --batchsize 120 --name resnet34_cutout.6_shift.5_224 --cutout_random --cutout --cutout_size 0.6 --affine_translate 0.5 --size 224 --epoch 120 --model resnet34 --patience 10
